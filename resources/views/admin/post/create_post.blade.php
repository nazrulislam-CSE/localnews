        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <div class="d-flex">
              ...
              <span class="mr-2"><a href="#">Add New Post</a></span>
            </div>
          </div><!-- /.col -->
                                ...
                                <div class="col-12 col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                                    <form action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div class="container">
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-12">
                                                            <img id="showImage" src="{{ asset('uploads/default.jpg')}}" class="user_img" alt="" style="width: 120px; height: 120px;">
                                                            @error('featured')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                            ...
                                            <div class="form-group" style="margin-top: 30px;">
                                                ...
                                                @error('tags')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <span><a href="{{ route('create.tag' )}}" class="btn btn-outline-danger btn-sm float-right ml-2">Create Tag</a></span>
                                                <div class="tag_scroll">
                                                    @foreach($tags as $tag)
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" id="checkbox" name="tags[]" value="{{ $tag->id }}"> {{ $tag->name }}
                                                        </label>
                                                    </div>
                                                    @endforeach
                                                </div>
                                        ...
                                        <div class="card-footer">
                                            <input type="submit" value="Create Post Now" class="btn btn-outline-primary btn-lg">
                                        </div>
                                    </form>
                                </div>
                            </div>
