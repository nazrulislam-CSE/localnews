        ...
        <div class="row mb-2">
          <div class="col-sm-6">
             <div class="d-flex">
              ...
              <span class="mr-2"><a href="{{ route('all.post') }}">Post</a> <i class="fas fa-angle-right"></i></span>
              <span class="mr-2"><a href="#">All Trashed Post</a></span>
            </div>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">All Trashed Post</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card col-lg-12">
          <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="card-title">Trashed Post List</h3>
          ...
          <div class="col-lg-12">
              <div class="card">
                  <div class="card-body p-0">
                      ...
                      <table class="table table-bordered table-hover table-striped table-responsive">
                          ...
                          @foreach($posts as $post)
                            <tr>
                              ...
                              <td>
                                <a href="#" class="btn btn-primary btn-sm offset-1 mt-2" data-toggle="modal" data-target="#parmanently_delete{{ $post->id }}"><i class="fas fa-undo fa-spin"></i> Restore</a>
                                <!-- start modal -->
                                <div class="modal fade" id="parmanently_delete{{ $post->id }}">
                                  <div class="modal-dialog">
                                    <div class="modal-content bg-primary">
                                      ...
                                      <div class="modal-body bg-light">
                                        <p>Are you sure post restore?</p>
                                      </div>
                                      <div class="modal-footer justify-content-between bg-light">
                                        <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                                        <a type="button" href="{{ route('restore.post',['id'=>$post->id]) }}" class="btn btn-primary"><i style="margin-right: 5px; color: white;" class="fas  fa-trash"></i><span class="text-light">OK</span></a>
                                      </div>
                                    </div>
                                    <!-- /.modal-content -->
                                  </div>
                                ...
                                <a href="#" class="btn btn-danger btn-sm  offset-1 mt-2" data-toggle="modal" data-target="#modal-primary{{ $post->id }}"><i class="fas fa-minus-circle"></i> Delete Permanently</a>
                                <!-- start modal -->
                                <div class="modal fade" id="modal-primary{{ $post->id }}">
                                  <div class="modal-dialog">
                                    <div class="modal-content bg-primary">
                                      ...
                                      <div class="modal-body bg-light">
                                        <p>Are you sure post parmanently deleted?</p>
                                      </div>
                                      <div class="modal-footer justify-content-between bg-light">
                                        <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                                        <a type="button" href="{{ route('kill.post',['id'=>$post->id]) }}" class="btn btn-primary"><i style="margin-right: 5px; color: white;" class="fas  fa-trash"></i><span class="text-light">OK</span></a>
                                      </div>
                                    </div>
                                    <!-- /.modal-content -->
                                  </div>
                    ...
                    @else
                      <span class="post_show">There Are No Trashed Post Yet.</span>
                    @endif
                  </div>
                  <!-- /.card-body -->
