        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <div class="d-flex">
              ...
              <span class="mr-2"><a href="#">Add New User</a></span>
            </div>
          </div><!-- /.col -->
                                ...
                                {{ csrf_field() }} 
                                    <div class="card-body">  
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            <input type="text" name="user" class="form-control" id="user" placeholder="type user name here">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="email" name="email" class="form-control" id="email" placeholder="type user email here">
                                        </div>
                                        <div class="form-group">
                                          <input type="submit" class="btn btn-outline-success btn-lg" value="Add Now">
                                        </div>
                                    </div>
                                </form>
                            </div>
